...
/**/
		...
		if (mysqli_affected_rows($dbc) === 1) { // If it ran OK.
			...
			echo '<h1>Your password has been changed.</h1><h2>'.$p.'</h2><p>You will receive the new, temporary password via email. Once you have logged in with this new password, you may change it by clicking on the "Change Password" link.</p>';
...
<form action="forgot_password.php" method="post" accept-charset="utf-8">
	...
	<div class="col-12 py-3">
		<button class="btn btn-primary btn-lg" type="submit" name="submit_button" id="submit_button">Reset &rarr;</button>
	</div>
</form>
